      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-20">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-3xl p-12 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div>
              <div className="w-16 h-16 mx-auto mb-4 rounded-2xl flex items-center justify-center transform rotate-2 shadow-lg" style={{ background: 'linear-gradient(135deg, #059669, #F59E0B)' }}>
