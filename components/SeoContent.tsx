...
export const SeoContent: React.FC = () => {
  return (
    <section className="py-20 px-6" style={{ borderTop: '1px solid rgba(59,130,246,0.1)' }}>
      <div className="max-w-5xl mx-auto">
        <div className="glass-card rounded-3xl p-10 lg:p-16 space-y-10">
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="space-y-3">
              <h3 className="text-xl font-black" style={{ color: '#F1F5F9' }}>
                Waarom IPTV kopen bij IPTVDark?
              </h3>
              <ul className="space-y-2 text-base" style={{ color: 'rgba(241,245,249,0.6)' }}>
                ...
                <li className="flex items-start gap-2"><span style={{ color: '#60A5FA' }}>✓</span> <span><strong>Alle Nederlandse kanalen</strong> — NPO, RTL, SBS, Veronica en meer</span></li>
                <li className="flex items-start gap-2"><span style={{ color: '#60A5FA' }}>✓</span> <span><strong>4K/8K kwaliteit</strong> zonder buffering of onderbrekingen</span></li>
                <li className="flex items-start gap-2"><span style={{ color: '#60A5FA' }}>✓</span> <span><strong>Direct actief in 5 minuten</strong> — IPTV kopen en gelijk kijken</span></li>
                <li className="flex items-start gap-2"><span style={{ color: '#60A5FA' }}>✓</span> <span><strong>15 dagen geld-terug-garantie</strong> — risicovrij IPTV kopen</span></li>
                <li className="flex items-start gap-2"><span style={{ color: '#60A5FA' }}>✓</span> <span><strong>Werkt op alle apparaten</strong> — Smart TV, telefoon, tablet, PC</span></li>
                <li className="flex items-start gap-2"><span style={{ color: '#60A5FA' }}>✓</span> <span><strong>Goedkoopste IPTV kopen</strong> — vanaf €24,99</span></li>
              </ul>
            </div>

            <div className="space-y-3">
              <h3 className="text-xl font-black" style={{ color: '#F1F5F9' }}>
                IPTVDark vs. traditionele TV
              </h3>
              <ul className="space-y-2 text-base" style={{ color: 'rgba(241,245,249,0.6)' }}>
                ...
                <li className="flex items-start gap-2"><span style={{ color: '#60A5FA' }}>✓</span> <span><strong>Geen lange contracten</strong> — flexibel IPTV kopen per maand</span></li>
                <li className="flex items-start gap-2"><span style={{ color: '#60A5FA' }}>✓</span> <span><strong>Meer kanalen</strong> dan welk kabelabonnement dan ook</span></li>
                <li className="flex items-start gap-2"><span style={{ color: '#60A5FA' }}>✓</span> <span><strong>Geen installateur nodig</strong> — zelf IPTV kopen &amp; instellen in 5 min</span></li>
                <li className="flex items-start gap-2"><span style={{ color: '#60A5FA' }}>✓</span> <span><strong>24/7 WhatsApp support</strong> — altijd bereikbaar</span></li>
                <li className="flex items-start gap-2"><span style={{ color: '#60A5FA' }}>✓</span> <span><strong>Pauzeer wanneer je wilt</strong> — volledige flexibiliteit</span></li>
              </ul>
            </div>
          </div>
