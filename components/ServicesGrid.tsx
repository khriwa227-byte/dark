...
const MoviePoster: React.FC<{ title: string; posterUrl: string }> = ({ title, posterUrl }) => (
  <div className="flex-shrink-0 group cursor-pointer">
    <div className="w-[180px] lg:w-[220px] aspect-[2/3] bg-white/10 rounded-3xl overflow-hidden shadow-2xl group-hover:shadow-[0_8px_24px_rgba(5,150,105,0.3)] transition-all duration-500 transform group-hover:-translate-y-2 relative border border-white/20">
      <img 
        src={posterUrl} 
        alt={title} 
...
const SportCard: React.FC<{ name: string; subtitle: string; icon: string; image: string }> = ({ name, subtitle, icon, image }) => (
  <div className="flex-shrink-0 group cursor-pointer">
    <div className="w-[160px] h-[284px] lg:w-[225px] lg:h-[400px] rounded-3xl overflow-hidden shadow-2xl group-hover:shadow-[0_8px_24px_rgba(245,158,11,0.3)] transition-all duration-500 transform group-hover:-translate-y-2 border border-white/20 relative">
