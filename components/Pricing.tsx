    ...
    <div className="mt-24 reveal">
      <div className="text-center mb-10">
        ...
        <h3 className="text-3xl lg:text-5xl font-black tracking-tighter text-white">
          IPTVDutch vs. <span className="text-italics" style={{ color: 'rgba(241,245,249,0.4)' }}>de rest</span>
        </h3>
            ...
            <tr style={{ background: 'rgba(59,130,246,0.08)' }}>
              ...
              <th className="px-6 py-4 text-center">
                <div className="flex flex-col items-center gap-1">
                  <span className="text-sm font-black uppercase tracking-wide" style={{ color: '#60A5FA' }}>IPTVDutch</span>
...
export const Pricing: React.FC = () => {
  ...
  const getWhatsAppUrl = (tier: typeof currentPeriod.tiers[0]) => {
    ...
    const message = `Hallo, ik wil graag het ${tier.tier}-pakket van IPTVDutch aanschaffen voor ${periodText} voor ${deviceText} (${pricing.price}).`;
    return `https://api.whatsapp.com/send/?phone=447414662070&text=${encodeURIComponent(message)}&type=phone_number&app_absent=0`;
  };

  return (
    <section id="iptvdutch" className="py-32 px-6" style={{ background: 'transparent' }}>
